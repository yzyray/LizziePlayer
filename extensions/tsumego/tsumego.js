...
// function extending board clicks
    ...
    var TsumegoApi = WGo.extendClass(WGo.Player, function (config) {
        ...
        this.listeners.variationEnd = [function (e) {
            console.log(e)
        }];
        this.listeners.nextMove = [function (e) {
            console.log(e)
        }];
    });
    ...
    Tsumego.prototype.variationEnd = function (e) {
        if (!e.node.comment) {
            switch (e.node._ev) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this.setInfo("Correct solution, but there is a better move.");
                    break;
                case 3:
        ...
        switch (e.node._ev) {
            case 0:
                this.setClass("wgo-tsumego-incorrect");
                break;
            case 1:
                this.setClass("wgo-tsumego-doubtful");
                break;
            case 2:
                this.setClass("wgo-tsumego-interesting");
                break;
            case 3:
                this.setClass("wgo-tsumego-correct");
                break;
            default:
                this.setClass("wgo-tsumego-unknown");
                break;
        }
    }
