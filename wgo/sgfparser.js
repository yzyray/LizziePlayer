        ...
        if (strs.length >= 2) {
            ...
            if (staticInfo.length == 3) {
                ...
                if(getStrLen(staticInfo[0])>20)
                    ...
                    node.comment2 ="\n"+WGo.t("winrate")+":" + (100-staticInfo[1]).toFixed(1) +"　"+WGo.t("totalPlayouts")+":"+ staticInfo[2];
            }
            if (staticInfo.length >= 4) {
                ...
                if(getStrLen(staticInfo[0])>20)
                    node.enginemin=staticInfo[0].substring(0,getFirst10(staticInfo[0]));
                    node.comment2 = "\n"+WGo.t("winrate")+":" + (100-staticInfo[1]).toFixed(1) + "　"+WGo.t("score")+":" + staticInfo[3] + "　"+WGo.t("totalPlayouts")+":" + staticInfo[2];
            }
